...
public class officer1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Loged as Officer1");
        ...
        addData.setBackground(new java.awt.Color(0, 0, 204));
        ...
        editData.setBackground(new java.awt.Color(0, 0, 204));
        ...
        editDataLayout.setHorizontalGroup(
            ...
            .addGroup(editDataLayout.createSequentialGroup()
                .addGap(28, 28, 28)
    ...
    private void addDataMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addDataMouseEntered
        // TODO add your handling code here:
        if(evt.getSource()==addData){
            addData.setBackground(new Color(135,135,135));
        }
        if(evt.getSource()==editData){
            editData.setBackground(new Color(135,135,135));
        }
    ...
    private void addDataMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addDataMouseExited
        // TODO add your handling code here:
        if(evt.getSource()==addData){
            addData.setBackground(new Color(0,0,204));
        }
        if(evt.getSource()==editData){
            editData.setBackground(new Color(0,0,204));
        }
        if(evt.getSource()==lgOut){
